...
export type usersActions =
    ...
    SetCurrentPageACType | setUserTotalCountACType |
    ShowLoaderACType | toggleIsFollowingACType
...
export const usersReducer = (state: initialStateUsersType = initialState, action: usersActions): initialStateUsersType => {
  switch (action.type) {
    case FOLLOW: {
